...
# V0.121: update requirements.text
# V0.122: update SDH-get-students-url
...
def inject_defaults():
    return dict(version='@ 2022 MB. V0.124', title=flask_app.config['HTML_TITLE'], site_name=flask_app.config['SITE_NAME'])
